...
namespace RecipesApp.Controllers
{
    public class FoodGroupsController : Controller
    {
        ...
        public FoodGroupsController(RecipesAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PlantBased")] FoodGroup foodGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PlantBased")] FoodGroup foodGroup)
        {
            if (id != foodGroup.Id)
            {
                return NotFound();
